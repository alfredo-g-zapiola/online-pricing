...
class SocialInfluence:
    ...
    def __init__(self, n_products=5):
        self.__n_products = n_products
        self.n_episodes = 1000
        self.n_steps_max = 10  # da definire in base ai costumers
        self.dataset = list()

    def simulate_episode(self, init_prob_matrix, n_step_max):
    ...
    def estimate_probabilities(self, node_index):
        """
